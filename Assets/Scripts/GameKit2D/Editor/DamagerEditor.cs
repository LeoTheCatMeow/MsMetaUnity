...
namespace Gamekit2D
{
    ...
    public class DamagerEditor : Editor
    {
        ...
        SerializedProperty m_useBrawlerCollision;
        SerializedProperty m_brawlerLayerWidth;
        ...
        void OnEnable ()
        {
            ...
            m_useBrawlerCollision = serializedObject.FindProperty("useBrawlerCollision");
            m_brawlerLayerWidth = serializedObject.FindProperty("brawlerLayerWidth");
        }
        ...
        public override void OnInspectorGUI ()
        {
            ...
            EditorGUILayout.PropertyField(m_useBrawlerCollision);
            if( m_useBrawlerCollision.boolValue ) {
                EditorGUI.indentLevel++;
                EditorGUILayout.PropertyField(m_brawlerLayerWidth);
                EditorGUI.indentLevel--;
            }
